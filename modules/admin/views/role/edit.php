            ...
            <div class="col-xs-12">
                <form class="form-horizontal" role="form" id="form1" action="/admin/operator/doadd" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="角色名称" name="name" id="name" value="<?= $row['name']; ?>" class="col-xs-10 col-sm-5"><i></i>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="description" name="description" rows="3" cols="45"><?= $row["description"]; ?></textarea><i></i>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="排序" id="listorder" name="listorder" value="<?=$row['sort_by']; ?>" class="col-xs-10 col-sm-1"><i></i>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label>
                                <input name="is_valid" value=1 type="radio" class="ace" <?php if($row['is_valid']==1){ echo "checked='checked'"; } ?> />
                                <span class="lbl"> 有效</span>
                            </label>
                             <label>
                                <input name="is_valid" value=0  <?php if($row['is_valid']==0){ echo "checked='checked'"; } ?> type="radio" class="ace" />
        ...
        var fValidator = {
            save:function(){
                ...
                if( validator.form() ){
                    var form = $('#form1');
                    var ajax = {
                        url:SITE_URL+"/admin/role/do-edit", data: form.serialize(), type: 'POST', dataType: 'json', cache: false,
