...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" id="form1" name="form1" action="/admin/menu/doedit" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" value="<?= $rs['name'] ?>" placeholder="菜单名称" id="name" name="name" class="col-xs-10 col-sm-5"><i></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="<?= $rs['alias_name'] ?>"  placeholder="英文名称" id="alias_name" name="alias_name"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="<?= $rs['action'] ?>"  placeholder="控制器名称" id="action" name="action"
                               class="col-xs-10 col-sm-5"><i></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" value="<?= $rs['method'] ?>"  placeholder="操作名称" id="method" name="method"
                               class="col-xs-10 col-sm-5"><i></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" value="<?= $rs['icon'] ?>"  placeholder="图标名称" id="icon" name="icon" class="col-xs-10 col-sm-5"><i></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" value="<?= $rs['listorder'] ?>"  placeholder="排序" id="listorder" name="listorder"
                               class="col-xs-10 col-sm-5"><i></i>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="<?= $rs['focus'] ?>"  placeholder="一级菜单别名" id="focus" name="focus"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="<?= $rs['active'] ?>"  placeholder="菜单选中别名" id="active" name="active"
                               class="col-xs-2 col-sm-2"><i></i>
                    </div>
                </div>
        ...
        var fValidator = {
            save: function () {
                if (validator.form()) {
                    ...
                    var form = $('#form1');
                    var ajax = {
                        url:SITE_URL+"<?= Url::toRoute('menu/doedit') ?>", data: form.serialize(), type: 'POST', dataType: 'json', cache: false,
