                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="space-6"></div>
                                    <form id="lgForm" action="/admin/public/dologin">
                                        <fieldset>
        ...
        validator = $("#lgForm").validate({
            ...
            errorPlacement: function(error, element) {
                if (error.html() != "") {
                    ...
                    $('#' + element.attr("id")).parent().siblings("i").addClass("note").css({"color":'red'}).html( error.html() );


                } else {
                    $('#' + element.attr("id")).parent().removeClass("state-error");
                    $('#' + element.attr("id")).parent().siblings("i").removeClass("note").css({"color":'red'}).html("");
                }
            },
